...
export default function LandingPage() {
  ...
  return (
    <header className="relative flex justify-center items-center">
      ...
      <nav className="bg-gray-50 fixed left-0 right-0 top-0 flex pr-30 pl-30 px-2 py-2 items-center px-10 top-0 justify-between z-10">
     ...
     <button
      ...
      <div className="w-full pr-30 pl-30 items-center justify-center">
        ...
        <div
            id="hero-sect"
            className="relative w-full  h-[24rem] rounded-2xl mt-32 flex flex-col items-center justify-center bg-[url(/easy-image.jpg)] bg-no-repeat bg-center bg-cover shadow-lg"
